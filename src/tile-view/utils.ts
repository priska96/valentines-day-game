...
export const whoIsOnMap = (x: number,y: number ,others:(CharacterState|NPC|ObjectNPC)[]): (NPC|ObjectNPC) | undefined => {
    let result = undefined;
    //debugger
    others.forEach((otherElem)=>{
        if(((otherElem as ObjectNPC).type === 'objectNPC')|| (otherElem as NPC).type === 'npc') {
